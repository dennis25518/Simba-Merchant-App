      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto p-6 md:p-12">
          <header className="mb-10 flex justify-between items-end">
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight">Operations Control</h2>
              <p className="text-slate-500 font-medium">Configure your kitchen throughput and store visibility.</p>
            </div>
            <button
              onClick={handleSaveAll}
              disabled={isSaving}
              className="bg-slate-900 text-white px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-black transition shadow-lg shadow-slate-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isSaving ? (
                <>
